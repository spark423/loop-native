<section id="login">
    ...
    <p>To reset your password, confirm your email below:</p>
    ...
    <div class="inputs">
        <form>
            ...
            <a href="#reset" class="uk-button uk-button-default" uk-toggle>
                Send Email
            </a>
...
<?php include 'elements/element-reset-modal.php'; ?>
